...
const SignIn = ({ navigation }) => {
  ...
  return (
    <SafeAreaView style={{
      ...
      <AntDesignIcon name="left" style={{ fontSize: 30 }} onPress={() => {
        navigation.goBack()
      }} />
      <SignInSignUpSVG width={350} height={250} />
      <View style={{
        position: 'absolute',
        bottom: 0,
        left: 0,
        ...
        <View style={{
          ...
          <View style={{
            ...
            <Text style={{
              ...
              onPress={() => { navigation.navigate('CreateAccountScreen') }}>Create Account</Text>
          </View>
        </View>
      </View>
    </SafeAreaView>
